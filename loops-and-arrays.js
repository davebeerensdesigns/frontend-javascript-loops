...
//names.forEach(name => console.log(name+"je"));
...
console.log(numbers);
console.log(numbers.map(function(number, i) {
    return number * (i % 2 === 0 ? 2 : 3);
}));
...
// ]
console.log(squares);
console.log(squares.map(function(number){
    return "Het volume van " + number +" is " + (number * number * number);
}))